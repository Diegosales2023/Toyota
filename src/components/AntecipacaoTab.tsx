          ...
          {submitted ? (
            <div className="bg-white border border-gray-100 shadow-md rounded-2xl p-6 sm:p-8 space-y-6 text-center py-10">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Recebemos suas informações com sucesso. Nossa equipe analisará sua solicitação sobre <strong className="text-slate-800">{assunto}</strong> e entrará em contato através dos dados informados (<strong className="text-slate-800">{email || telefone}</strong>).
                </p>
              </div>
              ...
              <a
                href={`mailto:suporte@centraldeapoio.com?subject=${encodeURIComponent(`[Banco Toyota] Solicitação - ${assunto} - ${nome}`)}&body=${encodeURIComponent(`Olá, gostaria de solicitar antecipação de parcelas:\n- Nome: ${nome}\n- CPF/CNPJ: ${cpf}\n- E-mail: ${email}\n- Telefone: ${telefone}\n- Assunto: ${assunto}\n\nEnviado via www.centraldeapoio.com`)}`}
                target="_blank"
