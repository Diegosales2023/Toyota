...
import { FileText, ShieldAlert, CheckCircle2, HelpCircle, Info, Phone, Mail, MessageSquare, AlertTriangle } from 'lucide-react';
        ...
        <div className="lg:col-span-5">
          {submitted ? (
            <div className="bg-white border border-gray-100 shadow-md rounded-2xl p-6 sm:p-8 space-y-6 text-center py-10">
              ...
              <a
                href={`mailto:suporte@centraldeapoio.com?subject=${encodeURIComponent(`[Banco Toyota] Solicitação - ${assunto} - ${nome}`)}&body=${encodeURIComponent(`Olá, gostaria de solicitar atendimento:\n- Nome: ${nome}\n- CPF/CNPJ: ${cpf}\n- E-mail: ${email}\n- Telefone: ${telefone}\n- Assunto: ${assunto}\n\nEnviado via www.centraldeapoio.com`)}`}
                target="_blank"
