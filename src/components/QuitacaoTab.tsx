        ...
        {submitted ? (
          <div className="lg:col-span-5 bg-white border border-gray-100 shadow-md rounded-2xl p-6 sm:p-8 space-y-6 text-center py-10">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                Recebemos suas informações com sucesso. Nossa equipe analisará os cálculos de quitação do seu contrato sobre <strong className="text-slate-800">{assunto}</strong> e retornará em breve.
              </p>
            </div>
