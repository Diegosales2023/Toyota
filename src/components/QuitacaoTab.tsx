          ...
          <div className="lg:col-span-5 bg-white border border-gray-100 shadow-md rounded-2xl p-6 sm:p-8 space-y-6 text-center py-12">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Sua solicitação de atendimento sobre <strong className="text-slate-800">{assunto}</strong> foi gerada com sucesso! O atendimento foi iniciado de forma rápida e segura.
              </p>
            </div>
